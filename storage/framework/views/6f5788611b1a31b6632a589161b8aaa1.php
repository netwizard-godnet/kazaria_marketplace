                        ...
                        <div class="col-12 text-center">
                            <div class="profile-photo-container">
                                <?php if($user->profile_pic_url): ?>
                                    <img src="<?php echo e($user->profile_pic_url); ?>" alt="Photo de profil" class="profile-photo rounded-circle" style="width: 120px; height: 120px; object-fit: cover; border: 4px solid #ff6b35;">
                                <?php else: ?>
