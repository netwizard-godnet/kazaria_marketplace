                ...
                <div class="card-body p-4">
                    <form id="createStoreForm" enctype="multipart/form-data">
                                            ...
                                            <optgroup label="<?php echo e($category->name); ?>">
                                                <option value="<?php echo e($category->id); ?>">
                                                    <?php if($category->icon): ?>
                                                        <?php echo e($category->name); ?> (Catégorie principale)
                                                    <?php else: ?>
                                                ...
                                                <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="sub_<?php echo e($subcategory->id); ?>">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('accueil')); ?>" class="btn btn-secondary btn-sm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('<?php echo e(route("store.store")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/store/create.blade.php ENDPATH**/ ?>