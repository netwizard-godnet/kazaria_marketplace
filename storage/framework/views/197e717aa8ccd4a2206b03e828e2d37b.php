            ...
            <form method="GET" action="<?php echo e(route('admin.reports.sales')); ?>" class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="delivered" <?php echo e(request('status') === 'delivered' ? 'selected' : ''); ?>>Livrées</option>
                        <option value="cancelled" <?php echo e(request('status') === 'cancelled' ? 'selected' : ''); ?>>Annulées</option>
                    </select>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-12 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.reports.export', 'sales')); ?>" class="btn btn-success"><i class="fas fa-download"></i> Export CSV</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="card card-stats card-round">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-title"><?php echo e(number_format($totals['orders'] ?? 0, 0, ',', ' ')); ?></h3>
                    <p class="text-muted">Payées: <?php echo e(number_format($totals['paid_orders'] ?? 0, 0, ',', ' ')); ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-stats card-round">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-title"><?php echo e(number_format($totals['amount'] ?? 0, 0, ',', ' ')); ?> <small>FCFA</small></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-stats card-round">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-title"><?php echo e(number_format($totals['avg_order_value'] ?? 0, 0, ',', ' ')); ?> <small>FCFA</small></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-stats card-round">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-title"><?php echo e(number_format($totals['total_items'] ?? 0, 0, ',', ' ')); ?></h3>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-info"><?php echo e($product->total_quantity); ?></span></td>
                                    <td><?php echo e(number_format($product->total_revenue, 0, ',', ' ')); ?> FCFA</td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e(Str::limit($category->name, 30)); ?></td>
                                    <td><span class="badge badge-primary"><?php echo e($category->total_quantity); ?></span></td>
                                    <td><?php echo e(number_format($category->total_revenue, 0, ',', ' ')); ?> FCFA</td>
                                    <td><?php echo e($category->orders_count); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-primary"><?php echo e($row->orders_count); ?></span></td>
                    ...
                    <tfoot>
                        <tr class="table-primary">
                            <th>Total</th>
                            <th><span class="badge badge-primary"><?php echo e($totals['orders']); ?></span></th>
                            <th><strong><?php echo e(number_format($totals['amount'], 0, ',', ' ')); ?> FCFA</strong></th>
                            <th><?php echo e(number_format($totals['avg_order_value'], 0, ',', ' ')); ?> FCFA</th>
                        </tr>
                    </tfoot>
                    <?php endif; ?>
                </table>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/reports/sales.blade.php ENDPATH**/ ?>