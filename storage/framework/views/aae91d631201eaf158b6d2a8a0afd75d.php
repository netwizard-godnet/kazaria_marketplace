                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="search" name="search" 
                                           value="<?php echo e(request('search')); ?>" placeholder="Nom ou description...">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sort_by" name="sort_by">
                                        <option value="order" <?php echo e(request('sort_by') === 'order' ? 'selected' : ''); ?>>Ordre</option>
                                        <option value="name" <?php echo e(request('sort_by') === 'name' ? 'selected' : ''); ?>>Nom</option>
                    ...
                    <?php if($categories->count() > 0): ?>
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">
                                                    ...
                                                    (<?php echo e($category->subcategories->where('is_active', true)->count()); ?> visibles) • 
                                                    <?php echo e($category->products->count()); ?> produits
                                                </small>
                                                <div class="mt-1">
                                                    ...
                                                    <?php if($category->order): ?>
                                                        <span class="badge badge-info">Ordre: <?php echo e($category->order); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <?php if($category->description): ?>
                                            <p class="text-muted small"><?php echo e(Str::limit($category->description, 100)); ?></p>
                                        <?php endif; ?>
                                        ...
                                        <?php if($category->subcategories->count() > 0): ?>
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <small class="text-muted">
                                                        <span class="badge badge-success badge-sm"><?php echo e($category->subcategories->where('is_active', true)->count()); ?> visibles</span>
                                                        <span class="badge badge-danger badge-sm"><?php echo e($category->subcategories->where('is_active', false)->count()); ?> masquées</span>
                                                    </small>
                                                </div>
                                                <div class="d-flex flex-wrap">
                                                    <?php $__currentLoopData = $category->subcategories->sortBy(function($subcategory) { return [$subcategory->order ?? 999, $subcategory->name]; })->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <span class="badge badge-<?php echo e($subcategory->is_active ? 'success' : 'secondary'); ?> mr-1 mb-1 small" title="<?php echo e($subcategory->is_active ? 'Visible sur le site' : 'Masquée sur le site'); ?>">
                                                            <?php echo e($subcategory->name); ?>

                                                            <i class="fas fa-<?php echo e($subcategory->is_active ? 'eye' : 'eye-slash'); ?> ml-1"></i>
                                                        </span>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($category->subcategories->count() > 3): ?>
                                                        <span class="badge badge-light mr-1 mb-1 small">+<?php echo e($category->subcategories->count() - 3); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="d-flex flex-wrap gap-2 justify-content-end">
                                                        ...
                                                        <form action="<?php echo e(route('admin.categories.toggle-status', $category)); ?>" 
                                                              method="POST" 
                                                              class="d-inline">
                                                            <?php echo csrf_field(); ?>
                                                            <button type="submit" 
                                                                    class="btn btn-<?php echo e($category->is_active ? 'secondary' : 'success'); ?> btn-sm action-btn" 
                                                                ...
                                                                <i class="fas fa-<?php echo e($category->is_active ? 'ban' : 'check'); ?> me-1"></i>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div class="text-muted">
                                Affichage de <?php echo e($categories->firstItem()); ?> à <?php echo e($categories->lastItem()); ?> sur <?php echo e($categories->total()); ?> catégories
                            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>