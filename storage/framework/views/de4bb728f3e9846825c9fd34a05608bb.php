            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control carousel-order" 
                           value="<?php echo e($carousel['order'] ?? ($index + 1)); ?>" 
                           min="1">
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\kazaria laravel v0\resources\views\admin\categories\partials\carousel-item.blade.php ENDPATH**/ ?>