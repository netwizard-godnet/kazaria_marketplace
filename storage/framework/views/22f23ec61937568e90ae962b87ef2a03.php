...
<body>
        ...
        <div class="header-top">
            ...
            <div class="header-right">
                ...
                <div class="invoice-info">
                    <strong>N° Facture:</strong> <?php echo e($invoice->invoice_number); ?><br>
                    <strong>Date:</strong> <?php echo e($invoice->invoice_date->format('d/m/Y')); ?><br>
                    <?php if($invoice->due_date): ?>
                        <strong>Date d'échéance:</strong> <?php echo e($invoice->due_date->format('d/m/Y')); ?><br>
                    <?php endif; ?>
                    <strong>Statut:</strong> <?php echo e($invoice->status_label); ?>
            ...
            <tr>
                <td style="width: 50%;">
                    ...
                    <div class="client-info">
                        ...
                        Email: <?php echo e($invoice->client_email); ?><br>
                        <?php if($invoice->client_phone): ?>
                            Téléphone: <?php echo e($invoice->client_phone); ?><br>
                        <?php endif; ?>
                        <?php if($invoice->client_address): ?>
                            <?php echo e($invoice->client_address); ?><br>
                        <?php endif; ?>
                        <?php if($invoice->client_city): ?>
                            <?php echo e($invoice->client_city); ?>

                            <?php if($invoice->client_postal_code): ?>, <?php echo e($invoice->client_postal_code); ?><?php endif; ?><br>
                        <?php endif; ?>
                        <?php if($invoice->client_country): ?>
                            <?php echo e($invoice->client_country == 'CI' ? 'Côte d\'Ivoire' : $invoice->client_country); ?>
                ...
                <td style="width: 50%;">
                    <?php if($invoice->order): ?>
                        ...
                        <div class="client-info">
                            N° Commande: <?php echo e($invoice->order->order_number); ?><br>
                            Date: <?php echo e($invoice->order->created_at->format('d/m/Y')); ?>
    ...
    <table class="items">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <strong><?php echo e($item['description'] ?? ($item['name'] ?? 'Article')); ?></strong>
                </td>
                <td class="text-center"><?php echo e($item['quantity'] ?? 1); ?></td>
                <td class="text-right"><?php echo e(number_format(floatval($item['price'] ?? 0), 0, ',', ' ')); ?> FCFA</td>
                <td class="text-right"><strong><?php echo e(number_format(floatval($item['total'] ?? (($item['quantity'] ?? 1) * ($item['price'] ?? 0))), 0, ',', ' ')); ?> FCFA</strong></td>
            </tr>
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right"><?php echo e(number_format($invoice->subtotal, 0, ',', ' ')); ?> FCFA</td>
            </tr>
            <?php if($invoice->tax_rate > 0): ?>
            <tr>
                <td colspan="3" class="text-right"><strong>TVA (<?php echo e($invoice->tax_rate); ?>%):</strong></td>
                <td class="text-right"><?php echo e(number_format($invoice->tax_amount, 0, ',', ' ')); ?> FCFA</td>
            </tr>
            <?php endif; ?>
            <?php if($invoice->shipping_cost > 0): ?>
            <tr>
                <td colspan="3" class="text-right"><strong>Frais de livraison:</strong></td>
                <td class="text-right"><?php echo e(number_format($invoice->shipping_cost, 0, ',', ' ')); ?> FCFA</td>
            </tr>
            <?php endif; ?>
            <?php if($invoice->discount > 0): ?>
            <tr>
                <td colspan="3" class="text-right"><strong>Réduction:</strong></td>
                <td class="text-right" style="color: #28a745;">-<?php echo e(number_format($invoice->discount, 0, ',', ' ')); ?> FCFA</td>
            </tr>
            <?php endif; ?>
            <tr class="total-row">
                <td colspan="3" class="text-right"><strong>TOTAL À PAYER:</strong></td>
                <td class="text-right" style="color: #f04e27; font-size: 16px;"><?php echo e(number_format($invoice->total, 0, ',', ' ')); ?> FCFA</td>
            </tr>
        </tfoot>
    </table>
    <?php elseif($invoice->description): ?>
    ...
    <div class="payment-info">
        ...
        <?php if($invoice->payment_reference): ?>
            <br><strong>Référence:</strong> <?php echo e($invoice->payment_reference); ?>

        <?php endif; ?>
        <?php if($invoice->status == 'paid'): ?>
            <br><span style="color: #28a745; font-weight: bold;">✓ Paiement reçu</span>
            <?php if($invoice->paid_date): ?>
                <br><span style="font-size: 10px;">Le <?php echo e($invoice->paid_date->format('d/m/Y')); ?></span>
            <?php endif; ?>
        <?php else: ?>
    ...
    <div class="footer">
        <p>
            ...
            Pour toute question, contactez-nous à <strong><?php echo e($companyEmail); ?></strong> ou au <strong><?php echo e($companyPhone); ?></strong><br>
            <br>
            <small><?php echo e($companyName); ?> - E-commerce en Côte d'Ivoire</small>
        </p>
    </div>
</body>
</html>

<?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/invoices/pdf.blade.php ENDPATH**/ ?>