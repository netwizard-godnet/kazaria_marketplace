                                        ...
                                        <tr class="item-row">
                                            ...
                                            <td>
                                                <input type="number" class="form-control item-quantity" name="items[<?php echo e($index); ?>][quantity]" 
                                                       value="<?php echo e($item['quantity'] ?? 1); ?>" min="1" step="1" required>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control item-price" name="items[<?php echo e($index); ?>][price]" 
                                                       value="<?php echo e($item['price'] ?? 0); ?>" step="0.01" min="0" required>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control item-total" name="items[<?php echo e($index); ?>][total]" 
                                                       value="<?php echo e($item['total'] ?? ($item['quantity'] ?? 1) * ($item['price'] ?? 0)); ?>" step="0.01" readonly>
                                            </td>
                                            <td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (loadOrderItemsBtn) {
        loadOrderItemsBtn.addEventListener('click', function() {
            const orderId = <?php echo json_encode($invoice->order_id ?? null, 15, 512) ?>;
            if (!orderId) {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/invoices/edit.blade.php ENDPATH**/ ?>