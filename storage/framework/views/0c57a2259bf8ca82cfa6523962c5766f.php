    ...
    <div class="container">
        <div class="header">
            ...
            <h1>
                <?php if($type === 'login'): ?>
                    Code de Connexion
                <?php elseif($type === 'password_reset'): ?>
        ...
        <div class="content">
            <?php if($userName): ?>
                <p class="message">Bonjour <strong><?php echo e($userName); ?></strong>,</p>
            <?php else: ?>
...
<?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/emails/auth-code.blade.php ENDPATH**/ ?>