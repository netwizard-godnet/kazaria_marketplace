                ...
                <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check mb-1">
                        ...
                        <label class="form-check-label filter-label" for="<?php echo e($prefix); ?>subcat<?php echo e($subcategory->id); ?>">
                            ...
                            <?php elseif($subcategory->icon && !empty($subcategory->icon)): ?>
                                <i class="<?php echo e($subcategory->icon); ?> me-1"></i>
                            <?php endif; ?>
...
<?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/components/category-filter-form.blade.php ENDPATH**/ ?>