...
unset($__errorArgs, $__bag); ?>" id="subcategory_id" name="subcategory_id">
                                        ...
                                        <?php if($product->subcategory_id): ?>
                                            <option value="<?php echo e($product->subcategory_id); ?>" selected><?php echo e($product->subcategory->name ?? ''); ?></option>
                                        <?php endif; ?>
                                    </select>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const currentSubcategoryId = <?php echo e($product->subcategory_id ?? 'null'); ?>;
    
    if (!categorySelect || !subcategorySelect) {
        return;
    }
    
    // Charger les sous-catégories pour la catégorie actuelle
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>