...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Gestion des Vendeurs</h4>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($user->store->name ?? 'N/A'); ?></td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center">Aucun vendeur trouvé</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/users/sellers.blade.php ENDPATH**/ ?>