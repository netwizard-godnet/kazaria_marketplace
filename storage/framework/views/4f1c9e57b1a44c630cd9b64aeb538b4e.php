                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4 p-4">
                            <div>
                                ...
                                <div class="mb-3">
                                    <span class="badge bg-success">En stock (<?php echo e($product->stock); ?> disponibles)</span>
                                </div>
                                    ...
                                    <div class="tab-pane fade" id="nav-ficheTech" role="tabpanel" aria-labelledby="nav-ficheTech-tab" tabindex="0">
                                        ...
                                        <table class="table table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Disponibilité</th>
                                                    <td><?php echo e($product->stock > 0 ? $product->stock . ' en stock' : 'Rupture de stock'); ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Note</th>
