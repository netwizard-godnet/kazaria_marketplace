                        ...
                        <table class="table table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($coupon->uses); ?><?php echo e($coupon->max_uses ? ' / '.$coupon->max_uses : ''); ?></td>
                                    <td>
                                        <?php if($coupon->starts_at): ?> <?php echo e($coupon->starts_at->format('d/m/Y H:i')); ?> <?php else: ?> — <?php endif; ?>
                                        <br>
                                        <?php if($coupon->ends_at): ?> <?php echo e($coupon->ends_at->format('d/m/Y H:i')); ?> <?php else: ?> — <?php endif; ?>
                                    </td>
                                    <td>
                                        <span class="badge <?php echo e($coupon->is_active ? 'bg-success' : 'bg-secondary'); ?>"><?php echo e($coupon->is_active ? 'Actif' : 'Inactif'); ?></span>
                                    </td>
                                    <td class="text-end">
                                        <form method="POST" action="<?php echo e(route('admin.coupons.toggle', $coupon)); ?>" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <button class="btn btn-sm btn-outline-primary"><?php echo e($coupon->is_active ? 'Désactiver' : 'Activer'); ?></button>
                                        </form>
                                        <form method="POST" action="<?php echo e(route('admin.coupons.destroy', $coupon)); ?>" class="d-inline" onsubmit="return confirm('Supprimer ce code ?')">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/coupons/index.blade.php ENDPATH**/ ?>