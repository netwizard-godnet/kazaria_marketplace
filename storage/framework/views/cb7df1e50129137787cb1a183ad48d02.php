...
<?php if($isCustomized && !empty($customColors)): ?>
<style>
    ...
    <?php if(isset($colors['background']) && $colors['background'] !== '#ffffff'): ?>
...
<?php endif; ?>
    ...
    <main class="container-fluid <?php echo e($isCustomized && !empty($customColors) ? 'category-custom-style' : ''); ?>">
