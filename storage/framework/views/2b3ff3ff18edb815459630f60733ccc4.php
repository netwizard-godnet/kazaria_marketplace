                    ...
                    <div class="bg-light p-4 rounded h-100">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mb-0">
                                ...
                                ?>
                                <a href="tel:<?php echo e($phoneLink); ?>" class="text-decoration-none">
                                    <i class="bi bi-phone me-2"></i><?php echo e($phoneNumber); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mb-0">
                                ...
                                ?>
                                <a href="mailto:<?php echo e($contactEmail); ?>" class="text-decoration-none">
                                    <i class="bi bi-envelope me-2"></i><?php echo e($contactEmail); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mb-0">
                                ...
                                <?php echo e($settings['contact_address'] ?? "Abidjan, Côte d'Ivoire"); ?>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                ?>
                                <a href="https://wa.me/<?php echo e($whatsappPhone); ?>" class="btn btn-success btn-sm" target="_blank">
                                    <i class="bi bi-whatsapp me-2"></i>WhatsApp
                                </a>
                                <a href="<?php echo e(route('help-faq')); ?>" class="btn blue-bg text-white btn-sm">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(route('help-faq')); ?>#faq2" class="btn blue-bg text-white btn-sm">En savoir plus</a>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(route('help-faq')); ?>#faq3" class="btn orange-bg text-white btn-sm">En savoir plus</a>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(route('help-faq')); ?>#faq4" class="btn blue-bg text-white btn-sm">En savoir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/contact.blade.php ENDPATH**/ ?>