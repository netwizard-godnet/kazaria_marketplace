...
<body>
    ...
    <div class="content">
        ...
        <div class="info-row">
            <span class="label">Nom complet :</span> <?php echo e($prenom); ?> <?php echo e($nom); ?>
        ...
        <?php if($telephone): ?>
        <div class="info-row">
            <span class="label">Téléphone :</span> <?php echo e($telephone); ?>

        </div>
        <?php endif; ?>

        <div class="info-row">
            <span class="label">Sujet :</span> <?php echo e($sujet); ?>

        </div>

        <div class="info-row">
            <span class="label">Date :</span> <?php echo e($date); ?>
    ...
    <div class="footer">
        ...
        <p>IP: <?php echo e($ip); ?> | Date: <?php echo e($date); ?></p>
    </div>
</body>
</html>
<?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/emails/contact.blade.php ENDPATH**/ ?>