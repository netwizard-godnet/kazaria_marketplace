        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.reports.products')); ?>" class="row g-3">
                ...
                <div class="col-md-12 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.reports.export', 'products')); ?>" class="btn btn-outline-success"><i class="fas fa-download"></i> Export CSV</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <h3 class="mb-0"><?php echo e(number_format($totals['products'] ?? 0, 0, ',', ' ')); ?></h3>
            </div>
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead><tr><th>Date</th><th>Nb produits</th></tr></thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($row->products_count); ?></td>
                        </tr>
