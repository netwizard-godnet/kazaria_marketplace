                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-3" id="customizationTabsContent">
                                    ...
                                    <div class="tab-pane fade" id="banners-pane" role="tabpanel">
                                        ...
                                        <input type="hidden" name="custom_banners" id="custom_banners_input" value="<?php echo e(json_encode($customBanners ?? [])); ?>">
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="carousels-pane" role="tabpanel">
                                        ...
                                        <input type="hidden" name="custom_carousels" id="custom_carousels_input" value="<?php echo e(json_encode($customCarousels ?? [])); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
