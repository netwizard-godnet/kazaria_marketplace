...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="card mt-3 mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_customized" id="is_customized" 
                                               value="1" <?php echo e(old('is_customized', $category->is_customized) ? 'checked' : ''); ?>>
                                ...
                                <div id="customization-panel" style="display: <?php echo e(old('is_customized', $category->is_customized) ? 'block' : 'none'); ?>;">
                                    <hr>
                                    ...
                                    <div id="sections-container">
                                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionKey => $sectionConfig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="card mb-2 section-item" data-section-key="<?php echo e($sectionKey); ?>">
                                                <div class="card-body">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-3">
                                                            <strong><?php echo e($sectionConfig['title'] ?? ucfirst(str_replace('_', ' ', $sectionKey))); ?></strong>
                                                            <?php if(isset($sectionConfig['is_custom']) && $sectionConfig['is_custom']): ?>
                                                                <br><small class="text-muted">
                                                                    <?php if($sectionConfig['type'] === 'banner'): ?>
                                                                        <i class="fas fa-image"></i> Bannière personnalisée
                                                                    <?php elseif($sectionConfig['type'] === 'carousel'): ?>
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control form-control-sm section-title" 
                                                                   name="section_titles[<?php echo e($sectionKey); ?>]" 
                                                                   value="<?php echo e($sectionConfig['title'] ?? ''); ?>" 
                                                                   placeholder="Titre de la section">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <input type="number" class="form-control form-control-sm section-order" 
                                                                   name="section_orders[<?php echo e($sectionKey); ?>]" 
                                                                   value="<?php echo e($sectionConfig['order'] ?? 999); ?>" 
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-check">
                                                                <input class="form-check-input section-enabled" type="checkbox" 
                                                                       name="section_enabled[<?php echo e($sectionKey); ?>]" 
                                                                       value="1" 
                                                                       <?php echo e(($sectionConfig['enabled'] ?? true) ? 'checked' : ''); ?>>
                                                                <label class="form-check-label">Activé</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <input type="hidden" class="section-key" value="<?php echo e($sectionKey); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="card mt-3 mb-3" id="advanced-customization-panel" style="display: <?php echo e(old('is_customized', $category->is_customized) ? 'block' : 'none'); ?>;">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-3" id="customizationTabsContent">
                                    ...
                                    <div class="tab-pane fade show active" id="colors-pane" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <?php $__currentLoopData = $colorFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colorKey => $colorInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-6 mb-3">
                                                    <label for="color_<?php echo e($colorKey); ?>" class="form-label">
                                                        <?php echo e($colorInfo['label']); ?>

                                                        <small class="text-muted d-block"><?php echo e($colorInfo['description']); ?></small>
                                                    </label>
                                                    <div class="input-group">
                                                        <input type="color" 
                                                               class="form-control form-control-color" 
                                                               id="color_<?php echo e($colorKey); ?>" 
                                                               name="custom_colors[<?php echo e($colorKey); ?>]"
                                                               value="<?php echo e($customColors[$colorKey] ?? $colorInfo['default']); ?>"
                                                               title="<?php echo e($colorInfo['label']); ?>">
                                                        <input type="text" 
                                                               class="form-control color-text-input" 
                                                               id="color_<?php echo e($colorKey); ?>_text"
                                                               value="<?php echo e($customColors[$colorKey] ?? $colorInfo['default']); ?>"
                                                               placeholder="<?php echo e($colorInfo['default']); ?>">
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <input type="hidden" name="custom_colors" id="custom_colors_input" value="<?php echo e(json_encode($customColors ?? [])); ?>" data-empty-value='{}'>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="banners-pane" role="tabpanel">
                                        ...
                                        <div id="banners-container">
                                            ...
                                            ?>
                                            <?php if(!empty($customBanners)): ?>
                                                <?php $__currentLoopData = $customBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo $__env->make('admin.categories.partials.banner-item', ['index' => $index, 'banner' => $banner], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                        <input type="hidden" name="custom_banners" id="custom_banners_input" value="<?php echo e(json_encode($customBanners ?? [])); ?>" data-empty-value='[]'>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="carousels-pane" role="tabpanel">
                                        ...
                                        <div id="carousels-container">
                                            ...
                                            ?>
                                            <?php if(!empty($customCarousels)): ?>
                                                <?php $__currentLoopData = $customCarousels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $carousel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo $__env->make('admin.categories.partials.carousel-item', ['index' => $index, 'carousel' => $carousel], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                        <input type="hidden" name="custom_carousels" id="custom_carousels_input" value="<?php echo e(json_encode($customCarousels ?? [])); ?>" data-empty-value='[]'>
                                    </div>
                                </div>
                            </div>
                        </div>
...
function attachBannerEvents(bannerElement) {
    ...
    imageInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            // Upload via AJAX
            fetch('<?php echo e(route("admin.categories.upload-image")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (oldImagePath && oldImagePath !== data.path && !oldImagePath.startsWith('data:')) {
                        fetch('<?php echo e(route("admin.categories.delete-image")); ?>', {
                            method: 'POST',
                            headers: {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>