                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('admin.banners.update-homepage-banner-1')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">Max 4MB, formats: JPG, PNG, GIF</small>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/banners/index_new.blade.php ENDPATH**/ ?>