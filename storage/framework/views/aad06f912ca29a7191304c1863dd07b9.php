...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="select" <?php echo e(old('type') === 'select' ? 'selected' : ''); ?>>Liste déroulante</option>
                                        <option value="checkbox" <?php echo e(old('type') === 'checkbox' ? 'selected' : ''); ?>>Cases à cocher</option>
                                        <option value="radio" <?php echo e(old('type') === 'radio' ? 'selected' : ''); ?>>Boutons radio</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               name="is_filterable" 
                                               value="1" 
                                               <?php echo e(old('is_filterable') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/admin/attributes/create.blade.php ENDPATH**/ ?>