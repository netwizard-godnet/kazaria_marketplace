...
<div class="position-relative" style="height: 300px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
    <?php if($store->banner): ?>
        <img src="<?php echo e($store->banner_url); ?>" alt="<?php echo e($store->name); ?>" class="w-100 h-100" style="object-fit: cover;">
            ...
            <div class="col-md-8">
                <div class="d-flex align-items-end">
                    ...
                    <div class="bg-white rounded-circle p-2 shadow" style="width: 120px; height: 120px; margin-bottom: -30px;">
                        <?php if($store->logo): ?>
                            <img src="<?php echo e($store->logo_url); ?>" alt="<?php echo e($store->name); ?>" class="w-100 h-100 rounded-circle" style="object-fit: cover;" onerror="this.onerror=null; this.src='<?php echo e(asset('images/logo-orange.png')); ?>';">
                        <?php else: ?>
                    ...
                    <div class="ms-4 text-white">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h1 class="fw-bold mb-0"><?php echo e($store->name); ?></h1>
                        ...
                        <p class="mb-2">
                            <i class="bi bi-tag-fill me-2"></i><?php echo e($store->category->name); ?>

                            <?php if($store->subcategory): ?>
                                <i class="bi bi-chevron-right mx-1"></i><?php echo e($store->subcategory->name); ?>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted small mb-1"><?php echo e($store->city ?? 'Non spécifiée'); ?></p>
                        <?php if($store->address): ?>
                            <p class="text-muted small"><?php echo e($store->address); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted small mb-1">
                            <i class="bi bi-envelope me-1"></i><?php echo e($store->email); ?>

                        </p>
                        <p class="text-muted small mb-0">
                            <i class="bi bi-phone me-1"></i><?php echo e($store->phone); ?>

                        </p>
                    </div>
                    
                    <?php if($store->social_links && count($store->social_links) > 0): ?>
                        <hr>
                        <h6 class="fw-bold mb-3">
                            <i class="bi bi-share me-2 orange-color"></i>Réseaux sociaux
                        </h6>
                        <div class="d-flex gap-2">
                            <?php if(isset($store->social_links['facebook'])): ?>
                                <a href="<?php echo e($store->social_links['facebook']); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                    <i class="bi bi-facebook"></i>
                                </a>
                            <?php endif; ?>
                            <?php if(isset($store->social_links['instagram'])): ?>
                                <a href="<?php echo e($store->social_links['instagram']); ?>" target="_blank" class="btn btn-sm btn-outline-danger">
                                    <i class="bi bi-instagram"></i>
                                </a>
                            <?php endif; ?>
                            <?php if(isset($store->social_links['twitter'])): ?>
                                <a href="<?php echo e($store->social_links['twitter']); ?>" target="_blank" class="btn btn-sm btn-outline-info">
                                    <i class="bi bi-twitter"></i>
                                </a>
                            <?php endif; ?>
                            <?php if(isset($store->social_links['website'])): ?>
                                <a href="<?php echo e($store->social_links['website']); ?>" target="_blank" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="col-md-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0" id="productsCount"><?php echo e($products->total()); ?> produits</p>
                </div>
                <div class="d-flex gap-2">
...
function shareStore() {
    if (navigator.share) {
        navigator.share({
            ...
            text: '<?php echo e($store->description); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/store/show.blade.php ENDPATH**/ ?>