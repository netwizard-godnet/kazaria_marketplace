                        ...
                        <div class="col-md-4 p-4">
                            <div>
                                ...
                                <div class="d-flex align-items-center justify-content-start" id="product-price-container">
                                    ...
                                    ?>
                                    <?php if($initialOldPrice && $initialOldPrice > $initialPrice): ?>
                                        
                                        <span class="fs-3 orange-color fw-bold text-nowrap me-2" id="current-price"><?php echo e(number_format($initialPrice, 0, ',', ' ')); ?> FCFA</span>
                                        <span class="fs-6 text-decoration-line-through text-secondary text-nowrap" id="old-price"><?php echo e(number_format($initialOldPrice, 0, ',', ' ')); ?> FCFA</span>
                                    <?php else: ?>
                                        
                                        <span class="fs-3 orange-color fw-bold text-nowrap" id="current-price"><?php echo e(number_format($initialPrice, 0, ',', ' ')); ?> FCFA</span>
                                        <span class="fs-6 text-decoration-line-through text-secondary text-nowrap" id="old-price" style="display: none;"></span>
                                    <?php endif; ?>
                                </div>
                                <div class="mb-3" id="savings-container" style="<?php echo e(($initialOldPrice && $initialOldPrice > $initialPrice) ? '' : 'display: none;'); ?>">
                                    <span class="fs-8 fw-bold orange-color mb-3" id="savings-amount">Vous avez épargné <?php echo e(number_format(($initialOldPrice ?? 0) - ($initialPrice ?? 0), 0, ',', ' ')); ?> FCFA</span>
                                </div>
                                ...
                                <div class="mb-3" id="stock-container">
                                    ...
                                    <?php if($initialStock > 0): ?>
                                        <span class="badge bg-success" id="stock-badge">En stock (<span id="stock-count"><?php echo e(number_format($initialStock, 0, ',', ' ')); ?></span> disponibles)</span>
                                    <?php else: ?>
                                ...
                                <div class="mb-3" id="quantity-container">
                                    ...
                                    <div class="input-group" style="max-width: 150px;">
                                        ...
                                        <input type="number" class="form-control text-center" id="quantityInput" value="1" min="1" max="<?php echo e($initialStock); ?>" readonly>
                                        <button class="btn btn-outline-secondary" type="button" onclick="changeQuantity(1)">
                                ...
                                <script>
                                    ...
                                    const productVariations = <?php echo json_encode($variationsData, 15, 512) ?>;
                                    ...
                                    const productBaseData = {
                                        price: <?php echo e((float)$product->price); ?>,
                                        old_price: <?php echo e($product->old_price && $product->old_price > $product->price ? (float)$product->old_price : 'null'); ?>,
                                        stock: <?php echo e((int)$product->stock); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/product.blade.php ENDPATH**/ ?>