            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control banner-order" 
                           value="<?php echo e($banner['order'] ?? ($index + 1)); ?>" 
                           min="1">
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\kazaria laravel v0\resources\views\admin\categories\partials\banner-item.blade.php ENDPATH**/ ?>