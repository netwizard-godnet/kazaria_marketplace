            ...
            <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-sm">
                            <?php if(Auth::user()->profile_pic_url && !empty(Auth::user()->profile_pic_url)): ?>
                                <img src="<?php echo e(str_starts_with(Auth::user()->profile_pic_url, 'http') ? Auth::user()->profile_pic_url : (str_starts_with(Auth::user()->profile_pic_url, 'images/') ? asset(Auth::user()->profile_pic_url) : Storage::url(Auth::user()->profile_pic_url))); ?>" alt="<?php echo e(Auth::user()->prenoms ?? 'Admin'); ?>" class="avatar-img rounded-circle">
                            <?php else: ?>
                                <div class="avatar-img rounded-circle bg-primary d-flex align-items-center justify-content-center text-white" style="width: 40px; height: 40px; font-size: 16px; font-weight: bold;">
                                    <?php echo e(strtoupper(substr(Auth::user()->prenoms ?? 'A', 0, 1))); ?><?php echo e(strtoupper(substr(Auth::user()->nom ?? 'U', 0, 1))); ?>
