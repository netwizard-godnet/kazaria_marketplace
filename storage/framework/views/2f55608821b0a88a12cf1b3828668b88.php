                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <ul>
                            ...
                            <li>Retours facilités selon la <a href="<?php echo e(route('politique-retour')); ?>">politique de retour</a></li>
                        </ul>

                        <h2 class="h5 mt-4">Nous contacter</h2>
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1"><i class="bi bi-envelope me-2"></i><?php echo e($settings['contact_email'] ?? 'contact@kazaria.com'); ?></li>
                            <li class="mb-1"><i class="bi bi-telephone me-2"></i><?php echo e($settings['contact_phone'] ?? '+225 07 00 00 00 00'); ?></li>
                            <li class="mb-1"><i class="bi bi-geo-alt me-2"></i><?php echo e($settings['contact_address'] ?? "Abidjan, Côte d'Ivoire"); ?></li>
                        </ul>

                        <div class="mt-4">
                            <a href="<?php echo e(route('contact')); ?>" class="btn orange-bg text-white me-2">
                                <i class="bi bi-chat-dots me-1"></i>Contactez‑nous
                            </a>
                            <a href="<?php echo e(route('help-faq')); ?>" class="btn btn-outline-secondary">
                                Aide & FAQ
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/qui-nous-sommes.blade.php ENDPATH**/ ?>