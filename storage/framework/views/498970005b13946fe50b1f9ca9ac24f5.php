    ...
    <script>
        ...
        async function loadOrders() {
            ...
            try {
                ...
                // Envoyer le paramètre status seulement s'il est défini
                if (filterStatus) {
                        ...
                        tbody.innerHTML = `
                            <tr>
                                <td colspan="5" class="text-center text-danger py-4">
                                    ...
                                    <button class="btn btn-primary mt-3" onclick="window.location.href='<?php echo e(route('login')); ?>'">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/israa/Desktop/kazaria_marketplace/resources/views/profil.blade.php ENDPATH**/ ?>