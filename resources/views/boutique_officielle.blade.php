                ...
                <div class="col-md-4">
                    ...
                    @if($boutiquePub1 && $boutiquePub1Image)
                        <div class="{{ $boutiquePub1->visibility_classes ?? '' }}">
                            ...
                            @endif
                        <img src="{{ $boutiquePub1Image }}" class="w-100 object-fit-cover" alt="Boutique Pub 1">
                ...
                <div class="col-md-4">
                    ...
                    @if($boutiquePub2 && $boutiquePub2Image)
                        <div class="{{ $boutiquePub2->visibility_classes ?? '' }}">
                            ...
                            @endif
                        <img src="{{ $boutiquePub2Image }}" class="w-100 object-fit-cover" alt="Boutique Pub 2">
                ...
                <div class="col-md-4">
                    ...
                    @if($boutiquePub3 && $boutiquePub3Image)
                        <div class="{{ $boutiquePub3->visibility_classes ?? '' }}">
                            ...
                            @endif
                        <img src="{{ $boutiquePub3Image }}" class="w-100 object-fit-cover" alt="Boutique Pub 3">
                ...
                <div class="col-md-8">
                    ...
                    @if($boutiquePub4 && $boutiquePub4Image)
                        <div class="{{ $boutiquePub4->visibility_classes ?? '' }}">
                            ...
                            @endif
                        <img src="{{ $boutiquePub4Image }}" class="w-100 object-fit-cover" alt="Boutique Pub 4">
                ...
                <div class="col-md-4">
                    ...
                    @if($boutiquePub5 && $boutiquePub5Image)
                        <div class="{{ $boutiquePub5->visibility_classes ?? '' }}">
                            ...
                            @endif
                        <img src="{{ $boutiquePub5Image }}" class="w-100 object-fit-cover" alt="Boutique Pub 5">
