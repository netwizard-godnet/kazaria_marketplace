        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ number_format($stats['total_amount'], 0) }} FCFA</h4>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="card bg-secondary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ number_format($stats['total_commission'], 0) }} FCFA</h4>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="search" class="form-control" value="{{ request('search') }}" placeholder="Référence, transaction, utilisateur...">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="payment_method" class="form-control">
                                        ...
                                        <option value="cinetpay" {{ request('payment_method') == 'cinetpay' ? 'selected' : '' }}>CinetPay</option>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.payments.export', request()->query()) }}" class="btn btn-success btn-sm">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <strong>{{ $payment->user->nom }} {{ $payment->user->prenoms }}</strong>
                                            <br><small class="text-muted">{{ $payment->user->email }}</small>
                                        </div>
                                    </td>
                                    <td>{{ $payment->store->name ?? 'N/A' }}</td>
                                    <td>
                                        <strong>{{ number_format($payment->amount, 0) }} FCFA</strong>
                                    </td>
                                    <td>
                                        {{ number_format($payment->commission_amount, 0) }} FCFA
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @if($payment->status === 'pending')
                                                <button type="button" class="btn btn-success btn-sm" onclick="markAsCompleted({{ $payment->id }})">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                                <button type="button" class="btn btn-warning btn-sm" onclick="cancelPayment({{ $payment->id }})">
                                                    <i class="fas fa-times"></i>
                                                </button>
                                            @endif
                                            @if($payment->status === 'completed')
                                                <button type="button" class="btn btn-danger btn-sm" onclick="refundPayment({{ $payment->id }})">
