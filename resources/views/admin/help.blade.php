...
@section('title', 'Aide & Documentation - KAZARIA Admin')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="text-muted">
                                <li>Consultez la <a href="{{ route('admin.documentation') }}" class="text-primary">documentation complète</a></li>
                                <li>Vérifiez le <a href="{{ route('admin.changelog') }}" class="text-primary">changelog</a> pour les dernières mises à jour</li>
