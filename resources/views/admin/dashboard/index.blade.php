...
<div class="page-inner">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['total_users'] ?? 0, 0, ',', ' ') }}</h4>
                                @if(isset($stats['users_growth_rate']))
                                <p class="card-category">
                                    <span class="text-{{ $stats['users_growth_rate'] >= 0 ? 'success' : 'danger' }}">
                                        <i class="fas fa-arrow-{{ $stats['users_growth_rate'] >= 0 ? 'up' : 'down' }}"></i>
                                        {{ abs($stats['users_growth_rate']) }}%
                                    </span> ce mois
                                </p>
                                @endif
                            </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['total_stores'] ?? 0, 0, ',', ' ') }}</h4>
                                @if(isset($stats['sellers_count']))
                                <p class="card-category">{{ $stats['sellers_count'] }} vendeurs</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['total_orders'] ?? 0, 0, ',', ' ') }}</h4>
                                @if(isset($stats['orders_growth_rate']))
                                <p class="card-category">
                                    <span class="text-{{ $stats['orders_growth_rate'] >= 0 ? 'success' : 'danger' }}">
                                        <i class="fas fa-arrow-{{ $stats['orders_growth_rate'] >= 0 ? 'up' : 'down' }}"></i>
                                        {{ abs($stats['orders_growth_rate']) }}%
                                    </span> ce mois
                                </p>
                                @endif
                            </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['total_products'] ?? 0, 0, ',', ' ') }}</h4>
                                @if(isset($stats['active_products']))
                                <p class="card-category">{{ $stats['active_products'] }} actifs</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['total_revenue'] ?? 0, 0, ',', ' ') }} <small>FCFA</small></h4>
                                @if(isset($stats['revenue_growth_rate']))
                                <p class="card-category">
                                    <span class="text-{{ $stats['revenue_growth_rate'] >= 0 ? 'success' : 'danger' }}">
                                        <i class="fas fa-arrow-{{ $stats['revenue_growth_rate'] >= 0 ? 'up' : 'down' }}"></i>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['monthly_revenue'] ?? 0, 0, ',', ' ') }} <small>FCFA</small></h4>
                                <p class="card-category">
                                    Aujourd'hui: {{ number_format($stats['today_revenue'] ?? 0, 0, ',', ' ') }} FCFA
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['average_order_value'] ?? 0, 0, ',', ' ') }} <small>FCFA</small></h4>
                                @if(isset($stats['total_items_sold']))
                                <p class="card-category">{{ number_format($stats['total_items_sold'], 0, ',', ' ') }} articles vendus</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{ number_format($stats['low_stock_products'] ?? 0, 0, ',', ' ') }}</h4>
                                @if(isset($stats['out_of_stock_products']))
                                <p class="card-category">{{ $stats['out_of_stock_products'] }} en rupture</p>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card card-stats card-round">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">{{ number_format($stats['pending_orders'] ?? 0, 0, ',', ' ') }}</h4>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card card-stats card-round">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">{{ number_format($stats['processing_orders'] ?? 0, 0, ',', ' ') }}</h4>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card card-stats card-round">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">{{ number_format($stats['delivered_orders'] ?? 0, 0, ',', ' ') }}</h4>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card card-stats card-round">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">{{ number_format($stats['cancelled_orders'] ?? 0, 0, ',', ' ') }}</h4>
    ...
    @if(isset($stats['total_invoices']) && canAccess('view_invoices'))
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.invoices.index') }}" class="btn btn-sm btn-primary">Voir toutes les factures</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">{{ $stats['total_invoices'] ?? 0 }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">{{ $stats['paid_invoices'] ?? 0 }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                <p class="card-category">En attente</p>
                                                <h4 class="card-title">{{ $stats['pending_invoices'] ?? 0 }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">{{ $stats['overdue_invoices'] ?? 0 }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="alert alert-success">
                                <strong>Montant total facturé:</strong> {{ number_format($stats['total_invoice_amount'] ?? 0, 0, ',', ' ') }} FCFA
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="alert alert-info">
                                <strong>Montant facturé ce mois:</strong> {{ number_format($stats['monthly_invoice_amount'] ?? 0, 0, ',', ' ') }} FCFA
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>#{{ Str::limit($order->order_number, 12) }}</td>
                                    <td>{{ Str::limit(($order->user->prenoms ?? 'N/A') . ' ' . ($order->user->nom ?? ''), 20) }}</td>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-info">{{ $product->sales_count ?? 0 }}</span></td>
                                    <td>{{ number_format($product->revenue ?? 0, 0, ',', ' ') }} FCFA</td>
                                    <td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ Str::limit(($customer->prenoms ?? 'N/A') . ' ' . ($customer->nom ?? ''), 25) }}</td>
                                    <td><span class="badge badge-primary">{{ $customer->orders_count ?? 0 }}</span></td>
                                    <td>{{ number_format($customer->total_spent ?? 0, 0, ',', ' ') }} FCFA</td>
                                </tr>
                                @empty
                                <tr>
...
<script>
    ...
    if (dailySalesCtx) {
        new Chart(dailySalesCtx.getContext('2d'), {
            type: 'bar',
            data: {
                labels: {!! $chart_data['daily_labels'] ?? "[]" !!},
                datasets: [{
                    label: 'Revenus (FCFA)',
    ...
    if (ordersStatusCtx) {
        const ordersByStatus = {!! $chart_data['orders_by_status'] ?? '{}' !!};
        const statusLabels = {
            'pending': 'En attente',
            'processing': 'En cours',
            'delivered': 'Livrées',
