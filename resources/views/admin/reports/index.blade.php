    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card card-stats card-round">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.reports.invoices') }}" class="btn btn-warning btn-sm btn-block">
                        <i class="fas fa-eye"></i> Voir
                    </a>
                </div>
            </div>
                    ...
                    <div class="row">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <span class="badge badge-success">{{ number_format($stats['total_revenue'] ?? 0, 0, ',', ' ') }} FCFA</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Ventes ce mois</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-primary">{{ number_format($stats['monthly_revenue'] ?? 0, 0, ',', ' ') }} FCFA</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Commandes totales</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-info">{{ number_format($stats['total_orders'] ?? 0, 0, ',', ' ') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Commandes complétées</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-success">{{ number_format($stats['completed_orders'] ?? 0, 0, ',', ' ') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Commandes en attente</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-warning">{{ number_format($stats['pending_orders'] ?? 0, 0, ',', ' ') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Produits en stock faible</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-danger">{{ number_format($stats['low_stock_products'] ?? 0, 0, ',', ' ') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Total factures</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-warning">{{ number_format($stats['total_invoices'] ?? 0, 0, ',', ' ') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Factures payées</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-success">{{ number_format($stats['paid_invoices'] ?? 0, 0, ',', ' ') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Montant factures payées</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-primary">{{ number_format($stats['total_invoice_amount'] ?? 0, 0, ',', ' ') }} FCFA</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Factures en retard</strong></td>
                                            <td class="text-end">
                                                <span class="badge badge-danger">{{ number_format($stats['overdue_invoices'] ?? 0, 0, ',', ' ') }}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('admin.products.index') }}" class="btn btn-outline-success btn-block">
                                    <i class="fas fa-box"></i> Gérer les produits
                                </a>
                                <a href="{{ route('admin.users.index') }}" class="btn btn-outline-info btn-block">
                                    <i class="fas fa-users"></i> Gérer les utilisateurs
                                </a>
                                <a href="{{ route('admin.stores.index') }}" class="btn btn-outline-warning btn-block">
                                    <i class="fas fa-store"></i> Gérer les boutiques
                                </a>
                                <a href="{{ route('admin.statistics.index') }}" class="btn btn-outline-secondary btn-block">
