                ...
                <li class="nav-item dropdown hidden-caret">
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn p-2">
                        <div class="dropdown-user-details">
                            <div class="user-name">{{ Auth::user()->prenoms ?? 'Admin' }} {{ Auth::user()->nom ?? 'User' }}</div>
                            <div class="dropdown-user-email">{{ Auth::user()->email ?? 'admin@kazaria.ci' }}</div>
                        </div>
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('accueil') }}" target="_blank">
