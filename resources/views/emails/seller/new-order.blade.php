...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Bonjour <strong>{{ $store->user->name ?? $store->name }}</strong>,</p>
            
            <p>Vous avez reçu une nouvelle commande pour votre boutique <strong>{{ $store->name }}</strong> sur KAZARIA !</p>
            
            <div class="order-info">
                <h3>📋 Informations de la commande</h3>
                <p><strong>Numéro de commande :</strong> <span class="highlight">{{ $order->order_number }}</span></p>
            ...
            <table>
                ...
                <tfoot>
                    <tr class="total-row">
                        ...
                        <td><strong>{{ number_format($storeTotal, 0, ',', ' ') }} FCFA</strong></td>
                    </tr>
                </tfoot>
            </table>
            ...
            <div class="order-info">
                ...
                @if($order->shipping_postal_code)
                    <p>Code postal : {{ $order->shipping_postal_code }}</p>
                @endif
            </div>
            ...
            <p style="text-align: center;">
                <a href="{{ route('store.order-details', $order->order_number) }}" class="button">
