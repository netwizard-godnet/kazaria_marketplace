...
class NotificationService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (settings.authorizationStatus == AuthorizationStatus.authorized) {
        ...
        print('🔔 [NOTIFICATION_SERVICE] Permission refusée');
        return;
      }
  ...
  Future<void> _registerTokenWithBackend(String token) async {
    try {
      ...
      if (authToken == null) {
        print('🔔 [NOTIFICATION_SERVICE] Pas de token d\'authentification');
        return;
      }
      ...
      if (response['success'] == true) {
        print('✅ [NOTIFICATION_SERVICE] Token enregistré sur le backend');
      } else {
  ...
  Future<void> unregisterToken() async {
    ...
    try {
      ...
      _fcmToken = null;
      print('✅ [NOTIFICATION_SERVICE] Token désenregistré');
    } catch (e) {
