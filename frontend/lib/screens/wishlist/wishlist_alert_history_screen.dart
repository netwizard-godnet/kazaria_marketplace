...
class WishlistAlertHistoryScreen extends StatefulWidget {
  ...
  @override
  State<WishlistAlertHistoryScreen> createState() =>
      _WishlistAlertHistoryScreenState();
}

class _WishlistAlertHistoryScreenState
    extends State<WishlistAlertHistoryScreen> {
  @override
  void initState() {
    super.initState();
      ...
      body: Consumer<WishlistProvider>(
        builder: (context, provider, _) {
          ...
          if (provider.alertsError != null && provider.alertItems.isEmpty) {
            return _buildError(provider.alertsError!, provider);
          }
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final log = provider.alertItems[index];
            ...
            if (metadata.isNotEmpty) ...[
              ...
              Wrap(
                ...
                children: metadata.entries
                    .map((entry) => _buildMetaChip(entry.key, entry.value))
                    .toList(),
              ),
            ],
          ],
