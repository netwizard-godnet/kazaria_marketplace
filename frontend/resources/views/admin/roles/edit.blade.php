...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Modifier le Rôle: {{ $role->name }}</h4>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="is_active" name="is_active">
                                        <option value="1" {{ old('is_active', $role->is_active) ? 'selected' : '' }}>Actif</option>
                                        <option value="0" {{ !old('is_active', $role->is_active) ? 'selected' : '' }}>Inactif</option>
                                    </select>
                                </div>
                            </div>
                        </div>
